...
rules2 = apriori(Groceries, parameter = list(support = 0.01, confidence = 0.5174)) # 10 rules
rules3 = apriori(Groceries, parameter = list(support = 0.01, confidence = 0.5173)) # 11 rules
...
rules = subset(rules, rhs %in% "whole milk")
inspect(rules)
